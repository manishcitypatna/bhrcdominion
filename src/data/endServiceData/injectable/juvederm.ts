export const juvederm = {
  ...
  whoIsThisFor: {
    ...
    description: "Ideal for those seeking volume restoration and contour enhancement.",
    items: [
      {
        title: "Volume Loss",
  ...
  howItWorks: {
    title: "How It Works",
    description: "A precise filler treatment designed for natural results.",
    steps: [
      {
        title: "Consultation",
  ...
  whatToExpect: {
    ...
    points: [
      ...
      { title: "Long Lasting", description: "Results last up to a year." }
    ]
  },
  ...
  faq: {
    ...
    items: [
      { question: "How long does Juvederm last?", answer: "6–12 months." },
      { question: "Is it safe?", answer: "Yes, FDA-approved filler." },
      { question: "Does it look natural?", answer: "Yes when done correctly." }
    ]
  }
};